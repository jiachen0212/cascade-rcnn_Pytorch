...
class detnet(_FPN):
    ...
    def _init_modules(self):
        ...
        self.RCNN_layer0 = nn.Sequential(detnet.conv1, detnet.bn1, detnet.relu, detnet.maxpool)   # 1
        self.RCNN_layer1 = nn.Sequential(detnet.layer1)  # 2
        self.RCNN_layer2 = nn.Sequential(detnet.layer2)  # 3
        self.RCNN_layer3 = nn.Sequential(detnet.layer3)  # 4
        self.RCNN_layer4 = nn.Sequential(detnet.layer4)  # 5
        ...
        self.RCNN_top = nn.Sequential(   # ROI Polling Size: POOLING_SIZE
        ...
        if self.class_agnostic:   # 只做fore/back的二分类
